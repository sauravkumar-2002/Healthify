...
interface Auth_interface_1 {
    ...
    ): Call<List<sign_up_log_in_model>>
    ...
    @GET("doctor")
    fun get_doctor_search_name(
        @Query("Name") Name: String,
        @Query("Speciality") Speciality: String
    ): Call<List<log_in_model_doctor>>
    ...
    suspend fun update_image(
        @Query("Phone") Phone: String,
        @Body userData: String
    ): Call<List<sign_up_log_in_model>>//change to list
    ...
    fun add_appointment_to_doctor(
        @Path("doctor") doctor: String,
        @Body userData: Appointment_doctor_user
    ): Call<Appointment_doctor_user>
    ...
    fun update_appointment_list(
        @Path("user") user: String,
        @Body userData: Appointment_user_doctor
    ): Call<Appointment_user_doctor>//change to list
