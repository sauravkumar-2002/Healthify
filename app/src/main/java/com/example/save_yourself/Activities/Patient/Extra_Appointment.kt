...
import com.example.save_yourself.databinding.ActivityExtraAppointmentBinding
import com.google.gson.Gson
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class Extra_Appointment : AppCompatActivity() {
    lateinit var binding: ActivityExtraAppointmentBinding
    lateinit var signUpModelObject: sign_up_log_in_model
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= DataBindingUtil.setContentView(this,R.layout.activity_extra_appointment)
    }
    ...
    private fun loadRecyclerview() {
        ...
        reqCall.enqueue(object : Callback<List<Appointment_user_doctor>> {
            override fun onResponse(
                ...
                adapter.setDoctorList(response.body()!![0].doctors,"pending")
